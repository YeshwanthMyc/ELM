...
public class ReceiptDeliveryVerificationLocators extends ReusableUtilities {
	...
	public void certificateNumber() throws InterruptedException {
		String certficateNumber = String.valueOf(certificateNo);
		Thread.sleep(1000);
...
Thread.sleep(1000);
	...
	public void enterExternalPenaltyDetails(String externalPenaltyName,String penaltyAmountToBeEntered) throws InterruptedException {
