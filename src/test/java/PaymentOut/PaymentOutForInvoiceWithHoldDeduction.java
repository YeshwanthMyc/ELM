...
public class PaymentOutForInvoiceWithHoldDeduction extends BaseClass{
	...
	@Test(dataProvider = "PaymentOutData",dependsOnGroups = "invHoldDeduction",groups="paymentHoldDeduction")
